<template>
  <internal-panel class="theme-panel">
    <h2 class="group-title" v-i18n>Configure theme#!28</h2>
    <div class="group">
      <div class="form-line">
        <span v-i18n class="link" @click="reset">Reset to default#!29</span>
      </div>
      <div class="form-line">
        <label class="form-label" v-i18n>Search#!19</label>
